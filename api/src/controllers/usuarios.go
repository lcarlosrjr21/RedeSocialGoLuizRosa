...
// AtualizarUsuario altera as informacoes de um usuario no bd
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	// se usuario logado é diferente do usuario no token
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao é possivel atualizar outro usuario"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível apagar outro usuario que não seja o seu"))
		return
	}
...
// BuscarSeguidores - permite verificar seguidores de um usuario
...
// BuscarSeguindo - permite verificar quem esta seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao é possivel atualizar senha de outro usuario"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual não corresponde a inserida"))
		return
	}
